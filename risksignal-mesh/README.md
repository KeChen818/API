...
The sidebar includes a display theme switch with `Grey` and `Red` modes. Summary visuals use embedded Apache ECharts for heatmaps, severity mixes, time-series views, and event ranking bars.
